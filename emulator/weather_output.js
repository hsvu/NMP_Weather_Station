...
exports.generate_weather_data = void 0;
/*
...
function generate_weather_data() {
    ...
    var rand_pos = getRandomIntInclusive(0, 5);
    var error_chance = getRandomIntInclusive(1, 10);
    var error_value = getRandomIntInclusive(500, 1000);
    switch (error_chance) {
        case 1:
